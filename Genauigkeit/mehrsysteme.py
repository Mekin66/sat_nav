...
# Anpassung auch fuer Galileo-Satelliten die ECEF-Position liefert. Andere
# Systeme (GLONASS 'R', BeiDou 'C') werden hier bewusst nicht beruecksichtigt,
# da sie ihre Ephemeriden in einem anderen Format uebertragen bzw. andere
# Bahnkonstanten benoetigen.
SYSTEME = ('G', 'E', 'C')
